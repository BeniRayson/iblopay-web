...
function apercuDocument(texte, couleur) {
    if (couleur === void 0) { couleur = '#2563eb'; }
    var svg = "<svg xmlns='http://www.w3.org/2000/svg' width='320' height='200'>\n    <rect width='320' height='200' rx='10' fill='#eef2ff'/>\n    <rect x='10' y='10' width='300' height='180' rx='8' fill='#ffffff' stroke='".concat(couleur, "' stroke-width='2'/>\n    <circle cx='55' cy='60' r='22' fill='").concat(couleur, "' opacity='0.25'/>\n    <rect x='95' y='45' width='170' height='10' rx='4' fill='").concat(couleur, "' opacity='0.35'/>\n    <rect x='95' y='63' width='120' height='8' rx='4' fill='").concat(couleur, "' opacity='0.2'/>\n    <rect x='30' y='100' width='260' height='8' rx='4' fill='#cbd5e1'/>\n    <rect x='30' y='118' width='260' height='8' rx='4' fill='#cbd5e1'/>\n    <rect x='30' y='136' width='180' height='8' rx='4' fill='#cbd5e1'/>\n    <text x='160' y='178' font-family='Arial' font-size='12' fill='").concat(couleur, "' text-anchor='middle' font-weight='bold'>").concat(texte, "</text>\n  </svg>");
    return 'data:image/svg+xml;utf8,' + encodeURIComponent(svg);
}
export var MOCK_SERVICES = [
    {
...
export var MOCK_RENDEMENT_GLOBAL = {
    demandesRecues: 2458,
...
export var MOCK_RENDEMENT_SERVICES = [
...
export var MOCK_SERVICE_INDICATEURS = [
    {
        serviceId: 5,

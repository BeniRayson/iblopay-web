...
// ─── ÉVÉNEMENTS ─────────────────────────────────────────────
var dansNJours = function (n) { return new Date(Date.now() + n * 24 * 3600000); };
var ilYANJours = function (n) { return new Date(Date.now() - n * 24 * 3600000); };
export var MOCK_EVENEMENTS = [
    {
...
function genererHistorique() {
    ...
    for (var _i = 0, configs_1 = configs; _i < configs_1.length; _i++) {
        ...
        for (var j = 0; j < 16; j++) {
            var quantite = 1 + Math.floor(Math.random() * 4);
            historique.push({
                id: id++,
...
export var MOCK_HISTORIQUE_VENTES = genererHistorique();
// ─── RÉCLAMATIONS ────────────────────────────────────────────
export var MOCK_RECLAMATIONS_EVENEMENTS = [
...
//# sourceMappingURL=mock-events-data.js.map
...
var LoadingInterceptor = function () {
    ...
    var _classThis;
    var LoadingInterceptor = _classThis = /** @class */ (function () {
        function LoadingInterceptor_1() {
            this.activeRequests = 0;
            this.isLoading$ = new BehaviorSubject(false);
            this.loading$ = this.isLoading$.asObservable();
        }
        LoadingInterceptor_1.prototype.intercept = function (req, next) {
            var _this = this;

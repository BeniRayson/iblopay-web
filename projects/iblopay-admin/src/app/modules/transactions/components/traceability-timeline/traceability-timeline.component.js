...
var TraceabilityTimelineComponent = function () {
    ...
    var TraceabilityTimelineComponent = _classThis = /** @class */ (function () {
        function TraceabilityTimelineComponent_1() {
            this.data = __runInitializers(this, _data_initializers, null);
            __runInitializers(this, _data_extraInitializers);
        }
        return TraceabilityTimelineComponent_1;
    }());
    __setFunctionName(_classThis, "TraceabilityTimelineComponent");
    (function () {
        ...
        TraceabilityTimelineComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TraceabilityTimelineComponent = _classThis;
}();
export { TraceabilityTimelineComponent };
//# sourceMappingURL=traceability-timeline.component.js.map
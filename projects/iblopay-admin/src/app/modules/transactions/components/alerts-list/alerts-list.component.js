...
var AlertsListComponent = function () {
    ...
    var AlertsListComponent = _classThis = /** @class */ (function () {
        function AlertsListComponent_1() {
            this.alerts = __runInitializers(this, _alerts_initializers, []);
            __runInitializers(this, _alerts_extraInitializers);
        }
        return AlertsListComponent_1;
    }());
    __setFunctionName(_classThis, "AlertsListComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _alerts_decorators = [Input()];
        ...
        AlertsListComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AlertsListComponent = _classThis;
}();
export { AlertsListComponent };

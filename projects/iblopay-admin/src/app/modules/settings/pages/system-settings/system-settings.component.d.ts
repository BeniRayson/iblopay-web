...
export declare class SystemSettingsComponent implements OnInit {
    ...
    toasts: Toast[];
    private toastSeq;
    sectionBaremeOuverte: 'retrait-client' | 'retrait-marchand' | 'recharge-client' | 'carte-agent' | null;
    modeEditionBareme: boolean;
    enregistrementBaremeEnCours: boolean;

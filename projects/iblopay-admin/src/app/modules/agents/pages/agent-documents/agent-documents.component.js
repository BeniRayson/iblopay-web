...
var AgentDocumentsComponent = function () {
    ...
    var _classThis;
    var AgentDocumentsComponent = _classThis = /** @class */ (function () {
        function AgentDocumentsComponent_1(route, router) {
            this.route = route;
            this.router = router;
            this.agent = null;
        }
        AgentDocumentsComponent_1.prototype.ngOnInit = function () {
            var _this = this;
            this.route.data.subscribe(function (data) {
                _this.agent = data['agent'];
            });
        };
        AgentDocumentsComponent_1.prototype.goBack = function () {
            this.router.navigate(['/agents']);
        };
        return AgentDocumentsComponent_1;
    }());

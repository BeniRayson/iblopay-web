...
var ServicesPublicsDetailComponent = function () {
    ...
    var ServicesPublicsDetailComponent = _classThis = /** @class */ (function () {
        function ServicesPublicsDetailComponent_1(route, router, servicesPublicsService) {
            ...
            this.demandesCurrentPage = 1;
            this.demandesItemsPerPage = 10;
            this.demandesTotalPages = 0;
        ...
        ServicesPublicsDetailComponent_1.prototype.initPagination = function () {
            ...
            this.demandesTotalPages = Math.ceil((((_k = (_j = this.service) === null || _j === void 0 ? void 0 : _j.demandesEnAttente) === null || _k === void 0 ? void 0 : _k.length) || 0) / this.demandesItemsPerPage);
            if (this.demandesTotalPages === 0)
                this.demandesTotalPages = 1;
        };
        // ============================================================
        // ACTIVITÉS EN TEMPS RÉEL
        // ============================================================
        ...
        ServicesPublicsDetailComponent_1.prototype.getTotalItems = function () {
            ...
            return (((_a = this.service.utilisateurs) === null || _a === void 0 ? void 0 : _a.length) || 0) +
                (((_b = this.service.demandesEnAttente) === null || _b === void 0 ? void 0 : _b.length) || 0) +
                (((_c = this.service.categories) === null || _c === void 0 ? void 0 : _c.length) || 0) +
                (((_d = this.service.typesRNF) === null || _d === void 0 ? void 0 : _d.length) || 0) +
                (((_e = this.service.paiements) === null || _e === void 0 ? void 0 : _e.length) || 0);
        };
        ...
        Object.defineProperty(ServicesPublicsDetailComponent_1.prototype, "paginatedDemandes", {
            get: function () {
                var _a;
                if (!((_a = this.service) === null || _a === void 0 ? void 0 : _a.demandesEnAttente))
                    return [];
                var start = (this.demandesCurrentPage - 1) * this.demandesItemsPerPage;
        ...
        // ============================================================
        ServicesPublicsDetailComponent_1.prototype.changeDemandesPage = function (page) {
            if (page < 1 || page > this.demandesTotalPages)
                return;
            this.demandesCurrentPage = page;
        };
        ServicesPublicsDetailComponent_1.prototype.getDemandesPaginationPages = function () {
            var pages = [];
            var maxVisible = 5;
            var start = Math.max(1, this.demandesCurrentPage - Math.floor(maxVisible / 2));
            var end = Math.min(this.demandesTotalPages, start + maxVisible - 1);
            if (end - start + 1 < maxVisible) {
                start = Math.max(1, end - maxVisible + 1);
            }
            for (var i = start; i <= end; i++) {
        ...
        // ============================================================
        ServicesPublicsDetailComponent_1.prototype.getDemandesParPriorite = function (priorite) {
            var _a;
            if (!((_a = this.service) === null || _a === void 0 ? void 0 : _a.demandesEnAttente))
                return 0;
            return this.service.demandesEnAttente.filter(function (d) { return d.priorite === priorite; }).length;
        };
        ServicesPublicsDetailComponent_1.prototype.getDemandesParStatut = function (statut) {
            var _a;
            if (!((_a = this.service) === null || _a === void 0 ? void 0 : _a.demandesEnAttente))
                return 0;
            return this.service.demandesEnAttente.filter(function (d) { return d.statut === statut; }).length;
        };
        // ============================================================
        // NAVIGATION
        // ============================================================
        ...
        // ACTIONS DEMANDES
        // ============================================================
        ServicesPublicsDetailComponent_1.prototype.onViewDemande = function (demande) {
            this.viewingDemande = demande;
        };
        ServicesPublicsDetailComponent_1.prototype.closeDemandeModal = function () {
            this.viewingDemande = null;
        };
        ServicesPublicsDetailComponent_1.prototype.onTraiterDemande = function (demande) {
            demande.statut = 'EN_COURS';
            this.addActivity('system', "Demande \"".concat(demande.reference, "\" mise en cours de traitement"));
        };
        ServicesPublicsDetailComponent_1.prototype.onRejeterDemande = function (demande) {
            if (confirm("\u00CAtes-vous s\u00FBr de vouloir rejeter la demande \"".concat(demande.reference, "\" ?"))) {
                demande.statut = 'REJETEE';
                this.addActivity('system', "Demande \"".concat(demande.reference, "\" rejet\u00E9e"));
            }
        };
        ServicesPublicsDetailComponent_1.prototype.onValiderDemande = function (demande) {
            if (confirm("\u00CAtes-vous s\u00FBr de vouloir valider la demande \"".concat(demande.reference, "\" ?"))) {
                demande.statut = 'VALIDEE';
                this.addActivity('system', "Demande \"".concat(demande.reference, "\" valid\u00E9e"));
            }
        };
        // ============================================================
        // EXPORT
        ...
        ServicesPublicsDetailComponent_1.prototype.exportDemandes = function () {

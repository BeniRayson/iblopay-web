...
var RecentTransactionsComponent = function () {
    ...
    var RecentTransactionsComponent = _classThis = /** @class */ (function () {
        function RecentTransactionsComponent_1() {
        ...
        RecentTransactionsComponent_1.prototype.getTransactionTypeLabel = function (type) {
            var labels = {
                'paiement': 'Paiement',
                'recharge': 'Recharge',
                'retrait': 'Retrait',
        ...
        RecentTransactionsComponent_1.prototype.getTransactionStatusLabel = function (status) {
            var labels = {
                'success': 'Succès',
                'pending': 'En attente',
                'failed': 'Échoué'
        ...
        RecentTransactionsComponent_1.prototype.getStatusClass = function (status) {
            var classes = {
                'success': 'success',
                'pending': 'pending',
                'failed': 'failed'
        ...
        RecentTransactionsComponent_1.prototype.formatCurrency = function (amount) {
            return amount.toLocaleString('fr-FR') + ' FBU';
        };
        return RecentTransactionsComponent_1;
    }());

...
var AgentsStatusComponent = function () {
    ...
    var _offline_decorators;
    var _offline_initializers = [];
    var _offline_extraInitializers = [];
    var _busy_decorators;
    var _busy_initializers = [];
    var _busy_extraInitializers = [];
    var AgentsStatusComponent = _classThis = /** @class */ (function () {
        function AgentsStatusComponent_1() {
        ...
        Object.defineProperty(AgentsStatusComponent_1.prototype, "total", {
            get: function () {
        ...
        Object.defineProperty(AgentsStatusComponent_1.prototype, "onlinePercentage", {
            get: function () {
        ...
        Object.defineProperty(AgentsStatusComponent_1.prototype, "offlinePercentage", {
            get: function () {
        ...
        Object.defineProperty(AgentsStatusComponent_1.prototype, "busyPercentage", {
            get: function () {
        ...
        return AgentsStatusComponent_1;
    }());
    ...
    (function () {
        ...
        __esDecorate(null, null, _offline_decorators, { kind: "field", name: "offline", static: false, private: false, access: { has: function (obj) { return "offline" in obj; }, get: function (obj) { return obj.offline; }, set: function (obj, value) { obj.offline = value; } }, metadata: _metadata }, _offline_initializers, _offline_extraInitializers);
        __esDecorate(null, null, _busy_decorators, { kind: "field", name: "busy", static: false, private: false, access: { has: function (obj) { return "busy" in obj; }, get: function (obj) { return obj.busy; }, set: function (obj, value) { obj.busy = value; } }, metadata: _metadata }, _busy_initializers, _busy_extraInitializers);

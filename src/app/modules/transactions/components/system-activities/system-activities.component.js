...
var SystemActivitiesComponent = function () {
    ...
    var SystemActivitiesComponent = _classThis = /** @class */ (function () {
        function SystemActivitiesComponent_1() {
            this.activities = __runInitializers(this, _activities_initializers, []);
            __runInitializers(this, _activities_extraInitializers);
        }
        return SystemActivitiesComponent_1;
    }());
    __setFunctionName(_classThis, "SystemActivitiesComponent");
    (function () {
        ...
        SystemActivitiesComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SystemActivitiesComponent = _classThis;
}();
export { SystemActivitiesComponent };
//# sourceMappingURL=system-activities.component.js.map
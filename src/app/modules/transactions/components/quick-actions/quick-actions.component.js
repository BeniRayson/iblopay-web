...
var QuickActionsComponent = function () {
    ...
    var QuickActionsComponent = _classThis = /** @class */ (function () {
        function QuickActionsComponent_1() {
            this.actions = __runInitializers(this, _actions_initializers, []);
            __runInitializers(this, _actions_extraInitializers);
        }
        return QuickActionsComponent_1;
    }());
    __setFunctionName(_classThis, "QuickActionsComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _actions_decorators = [Input()];
        ...
        QuickActionsComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return QuickActionsComponent = _classThis;
}();

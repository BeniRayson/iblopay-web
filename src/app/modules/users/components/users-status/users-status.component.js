...
var UsersStatusComponent = function () {
    ...
    var _selectedStatus_decorators;
    var _selectedStatus_initializers = [];
    var _selectedStatus_extraInitializers = [];
    ...
    var _statusSelected_decorators;
    var _statusSelected_initializers = [];
    var _statusSelected_extraInitializers = [];
    var _confirm_decorators;
    var _confirm_initializers = [];
    var _confirm_extraInitializers = [];
    var UsersStatusComponent = _classThis = /** @class */ (function () {
        function UsersStatusComponent_1() {
            this.user = __runInitializers(this, _user_initializers, null);
            this.currentStatus = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _currentStatus_initializers, ''));
            this.selectedStatus = (__runInitializers(this, _currentStatus_extraInitializers), __runInitializers(this, _selectedStatus_initializers, ''));
            this.isLoading = (__runInitializers(this, _selectedStatus_extraInitializers), __runInitializers(this, _isLoading_initializers, false));
            ...
            this.isOpen = (__runInitializers(this, _success_extraInitializers), __runInitializers(this, _isOpen_initializers, false));
            this.close = (__runInitializers(this, _isOpen_extraInitializers), __runInitializers(this, _close_initializers, new EventEmitter()));
            this.statusSelected = (__runInitializers(this, _close_extraInitializers), __runInitializers(this, _statusSelected_initializers, new EventEmitter()));
            this.confirm = (__runInitializers(this, _statusSelected_extraInitializers), __runInitializers(this, _confirm_initializers, new EventEmitter()));
            // ─── OTP ──────────────────────────────────────────────────
        ...
        UsersStatusComponent_1.prototype.ngOnChanges = function (changes) {
            var _this = this;
        ...
        UsersStatusComponent_1.prototype.ngOnDestroy = function () {
            this.clearAllTimers();
        };
        // ─── OTP ──────────────────────────────────────────────────
        UsersStatusComponent_1.prototype.generateAndSendOtp = function () {
        ...
        UsersStatusComponent_1.prototype.startOtpTimer = function () {
            var _this = this;
            this.clearAllTimers();
        ...
        UsersStatusComponent_1.prototype.startLockTimer = function (seconds) {
            var _this = this;
        ...
        UsersStatusComponent_1.prototype.clearOtpTimer = function () {
            if (this.otpTimerInterval) {
                clearInterval(this.otpTimerInterval);
                this.otpTimerInterval = null;
            }
        };
        UsersStatusComponent_1.prototype.clearLockTimer = function () {
            if (this.lockTimerInterval) {
                clearInterval(this.lockTimerInterval);
                this.lockTimerInterval = null;
            }
        };
        UsersStatusComponent_1.prototype.clearAllTimers = function () {
            this.clearOtpTimer();
            this.clearLockTimer();
        };
        UsersStatusComponent_1.prototype.verifyOtp = function () {
        ...
        UsersStatusComponent_1.prototype.resendOtp = function () {
            var _this = this;
            if (this.isOtpLocked) {
        ...
        // ─── NAVIGATION ───────────────────────────────────────────
        UsersStatusComponent_1.prototype.goBackToOtp = function () {
            this.showStatusStep = false;
            this.showOtpStep = true;
            this.error = '';
        };
        UsersStatusComponent_1.prototype.resetForm = function () {
            this.showOtpStep = true;
            this.showStatusStep = false;
            this.otpCode = '';
            this.otpError = '';
        ...
        // ─── ACTIONS ──────────────────────────────────────────────
        UsersStatusComponent_1.prototype.onClose = function () {
            this.resetForm();
            this.close.emit();
        };
        UsersStatusComponent_1.prototype.onSelectStatus = function (value) {
            this.statusSelected.emit(value);
        };
        UsersStatusComponent_1.prototype.onConfirm = function () {
            this.confirm.emit();
        };
        // ─── UTILITAIRES ──────────────────────────────────────────
        UsersStatusComponent_1.prototype.getStatusLabel = function (status) {
        ...
        UsersStatusComponent_1.prototype.getStatusClass = function (status) {
            return "status-".concat(status.toLowerCase());
        };
        UsersStatusComponent_1.prototype.getStatusOptionColor = function (status) {
            var option = this.statusOptions.find(function (s) { return s.value === status; });
            return (option === null || option === void 0 ? void 0 : option.color) || '#6b7280';
        };
        UsersStatusComponent_1.prototype.getStatusOptionIcon = function (status) {
            var option = this.statusOptions.find(function (s) { return s.value === status; });
            return (option === null || option === void 0 ? void 0 : option.icon) || 'fa-circle';
        };
        UsersStatusComponent_1.prototype.getInitials = function (firstName, lastName) {
        ...
        UsersStatusComponent_1.prototype.getAvatarColor = function (id) {
        ...
        UsersStatusComponent_1.prototype.getRoleLabel = function (role) {
            var labels = {
                'CLIENT': 'Client',
                'AGENT': 'Agent',
        ...
        UsersStatusComponent_1.prototype.getOtpRemainingTime = function () {
            if (this.otpTimer <= 0)
                return 'Expiré';
        ...
        UsersStatusComponent_1.prototype.getLockRemainingTime = function () {
        ...
        return UsersStatusComponent_1;
    }());
    __setFunctionName(_classThis, "UsersStatusComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _user_decorators = [Input()];
        _currentStatus_decorators = [Input()];
        _selectedStatus_decorators = [Input()];
        ...
        _statusSelected_decorators = [Output()];
        ...
        __esDecorate(null, null, _selectedStatus_decorators, { kind: "field", name: "selectedStatus", static: false, private: false, access: { has: function (obj) { return "selectedStatus" in obj; }, get: function (obj) { return obj.selectedStatus; }, set: function (obj, value) { obj.selectedStatus = value; } }, metadata: _metadata }, _selectedStatus_initializers, _selectedStatus_extraInitializers);
        ...
        __esDecorate(null, null, _statusSelected_decorators, { kind: "field", name: "statusSelected", static: false, private: false, access: { has: function (obj) { return "statusSelected" in obj; }, get: function (obj) { return obj.statusSelected; }, set: function (obj, value) { obj.statusSelected = value; } }, metadata: _metadata }, _statusSelected_initializers, _statusSelected_extraInitializers);
        ...
        UsersStatusComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UsersStatusComponent = _classThis;
}();
export { UsersStatusComponent };
//# sourceMappingURL=users-status.component.js.map